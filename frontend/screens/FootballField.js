...
const FootballField = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, alignItems: 'center', backgroundColor: '#000' }}>
        <View style={{ backgroundColor: '#FFF', height: 0.33*(windowHeight), width: valuationWidth, borderRadius: 10 }}>
          ...
          >
            { valuations.map(( valuation ) => {
              ...
              <> 
                ...
                <TouchableOpacity style={{ marginStart: (valuation.minValuation - table.minRange)*pixelsPerDollar, marginTop: 5, marginBottom: 5, backgroundColor: valuation.color, height: valuationHeight, width: (valuation.maxValuation - valuation.minValuation) * pixelsPerDollar }}></TouchableOpacity>
              </>
              )
            })}
          </ScrollView>
